...
You need to attach your Oppo Find X6 Pro with the PC through a USB Cable. Following the connection, you need to tap on the option of “Transfer Files” provided in the prompt message.
...
Now you can see your Oppo Find X6 Pro phone screen on the computer screen.

![mirror Oppo Find X6 Pro phone on pc using MirrorGo](https://images.wondershare.com/drfone/article/2021/03/mirror-xiaomi-to-pc-using-mirrorgo.jpg)

<!-- affiliate ads begin -->
<a href="https://sentrypc.7eer.net/c/5597632/398453/3022" target="_top" id="398453"><img src="//a.impactradius-go.com/display-ad/3022-398453" border="0" alt="www.sentrypc.com" width="580" height="400"/></a><img height="0" width="0" src="https://sentrypc.7eer.net/i/5597632/398453/3022" style="position:absolute;visibility:hidden;" border="0" />
<!-- affiliate ads end -->
## Part 3: Screen Mirroring Oppo Find X6 Pro to PC via USB – Scrcpy

You can utilize another conventional mechanism of screen mirroring your Oppo Find X6 Pro to PC using the Phone's Scrcpy. Initially, you need its extension file on your computer, which can be downloaded from the Internet with ease.
...
A list shall appear on the Command Prompt, showing a list of all the local IP addresses associated with the computer. You need to locate the IP address of your Oppo Find X6 Pro Android phone and have it copied on the clipboard.
...
Following this, you need to remove the USB cable and continue using your phone using the ADB connection through the Wi-Fi and Hotspot connection of your phone. To confirm, you can check the Oppo Find X6 Pro device connected through Vysor to observe it active on the list. You can simply connect to the phone in a normal manner for screen mirroring Oppo Find X6 Pro to PC.
...
<!-- affiliate ads end -->
## Part 5: Screen Mirroring Oppo Find X6 Pro to PC with Mi PC Suite

**Step 1: Download Mi PC Suite**

To successfully screen share your Oppo Find X6 Pro to PC, you can access the official website of Mi PC Suite to have it downloaded on the PC.

**Step 2: Launch the PC Suite**

After downloading the application, you need to simply launch it and observe the screen on the front showing the option of Connect your Device. You need to attach your Oppo Find X6 Pro phone to your PC using USB Cable.
...
<!-- affiliate ads end -->
## Full Guide on Mirroring Your Oppo Find X6 Pro to Your PC/Mac
...
- • Both the Oppo Find X6 Pro devices will search each other automatically.
...
- • After installing Miracast from the above-mentioned link on your Android device swipe from the right and select the Oppo Find X6 Pro devices option.
...
- • From your PC, you can go to the Settings and click on the Oppo Find X6 Pro devices tab. By clicking on the "Add a device" option, you can search for the Miracast receiver.
- • From your device, go to Settings and from there to the Oppo Find X6 Pro device section and tap on Display. Select Cast Screen from there.
...
For mirroring Android to PC via a USB, you must got JAVA installed on your PC. On the other hand, the Developer mode should be enabled on your Android device for the successful mirroring of the Oppo Find X6 Pro device.
...
- • Now you can connect your Oppo Find X6 Pro to your computer through a USB
- • Open the Oppo Find X6 Pro device Manager and look for your Android device.
...
- • Enable the Find My Oppo Find X6 Pro function by turning it on and tapping on the Activate option.
